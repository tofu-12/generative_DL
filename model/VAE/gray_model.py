...
sys.path.append(os.path.join(os.path.join(__file__), os.pardir, os.pardir))
...
class VAEEncoder(nn.Module):
    def __init__(self, latent_dim: int):
        ...
        self.fc_z_mean = nn.Linear(128 * 2 * 2, latent_dim)
        self.fc_z_log_var = nn.Linear(128 * 2 * 2, latent_dim)
